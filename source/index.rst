...
The software can be used in many different ways. For example, with OpenALPR, you can:
  ...
  #. Recognize license plates from camera streams. The results are :ref:`browsable, searchable, and can trigger alerts <web_server>`. The data repository can be in the cloud or stored entirely within your on-site network. 
